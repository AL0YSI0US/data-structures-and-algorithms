...
Write a function named removeEvenValues that, given an array of integers as input, deletes all
even values from the array, leaving no 'gaps' behind.
...
first element is the original string with all the vowels removed, and the second element is a
